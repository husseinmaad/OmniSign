# DocuSign React Native Client 

This is a slight modification of the `docusign-esign` package on NPM. It gets rid of incompatibilities with React Native (no filesystem access, so no `fs` module), but has the same interface. 


Sample Application: https://github.com/nicholasareed/docusign-esign-react-native-sample

docusign-esign package: https://github.com/docusign/docusign-node-client
...
The DocuSign React Native Client is licensed under the following [License](LICENSE).
